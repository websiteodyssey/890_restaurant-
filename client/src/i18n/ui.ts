...
export const UI: Record<Lang, Strings> = {
  fr: {
    ...
    slides: [
      { title: "Poisson grillé à la sichuanaise", desc: "Poisson entier grillé, bouillon mala, piments et ciboule." },
      { title: "Poulet du chef en poêle", desc: "Poulet mijoté, pommes de terre, piments et poivre du Sichuan." },
  ...
  en: {
    ...
    slides: [
      { title: "Sichuan-style grilled fish", desc: "Whole grilled fish, mala broth, chillies and spring onion." },
      { title: "Chef's chicken hot pot", desc: "Simmered chicken, potatoes, chillies and Sichuan pepper." },
  ...
  zh: {
    ...
    slides: [
      { title: "川式烤鱼", desc: "整条烤鱼，麻辣汤底，辣椒与葱花。" },
      { title: "招牌干锅鸡", desc: "焖煮鸡肉、土豆、辣椒与四川花椒。" },
