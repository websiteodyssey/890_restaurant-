...
export const UI: Record<Lang, Strings> = {
  fr: {
    ...
    slides: [
      ...
      { title: "Calamars au wok sec", desc: "Calamars sautés au wok sec, piments, ail et poivre du Sichuan." },
  ...
  en: {
    ...
    slides: [
      ...
      { title: "Dry-pot squid", desc: "Wok-fried squid, chillies, garlic and Sichuan pepper." },
  ...
  zh: {
    ...
    slides: [
      ...
      { title: "干锅鱿鱼", desc: "干锅鱿鱼，辣椒、蒜与花椒 —— 香辣鲜嫩。" },
